...
for private_key in keys_list:
    ...
    to = web3.to_checksum_address("0xB0460044Ea259D4b971f322c34Ed4505Cf180247")
    amount = web3.to_wei("0.0001", 'ether')
    # value = int(amount)
    value = 0
    data = ""
